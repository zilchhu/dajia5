...
const menuList = [
  {"id":1,"parentId":null,"sort":0,"name":"dome","href":"/index","icon":"fa fa-dashboard","children":[],
    "isShow":"1"},
  {"id":31,"parentId":null,"sort":1,"name":"美团","href":"/test/1","icon":"fa fa-upload","children":
    [
      {"id":92,"parentId":31,"sort":0,"name":"经营数据","href":"/test/1/1","icon":"fa fa-bank","children":[
        {"id":912,"parentId":92,"sort":0,"name":"xxx指标","href":"/test/1/1/1","icon":"fa fa-bank","children":[],"isShow":"1"},
        {"id":913,"parentId":92,"sort":0,"name":"xxx指标","href":"/test/1/1/2","icon":"fa fa-area-chart","children":[],"isShow":"1"}
      ],"isShow":"1"},
      {"id":93,"parentId":31,"sort":0,"name":"活动数据","href":"/test/1/2","icon":"fa fa-area-chart","children":[],"isShow":"1"}
    ]
    ,"isShow":"1"},

  {"id":31,"parentId":null,"sort":1,"name":"饿了么","href":"/test/1","icon":"fa fa-upload","children":
      [
        {"id":92,"parentId":31,"sort":0,"name":"经营数据","href":"/test/1/1","icon":"fa fa-bank","children":[
            {"id":912,"parentId":92,"sort":0,"name":"xxx指标","href":"/test/1/1/1","icon":"fa fa-bank","children":[],"isShow":"1"},
            {"id":913,"parentId":92,"sort":0,"name":"xxx指标","href":"/test/1/1/2","icon":"fa fa-area-chart","children":[],"isShow":"1"}
